...
## Pros
Although not ideal, this algorithm has several aspects that make it interesting an unique. First of all, it is 100% github based, from data storage and data processing to website hosting, which makes everything on one platorm. This makes it really easy to manage, and 
